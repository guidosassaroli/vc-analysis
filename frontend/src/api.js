...
export const updateStatus     = (id, status, passReason = null) => patch(`/startups/${id}/status`, { json: { status, pass_reason: passReason } })
...
export const generateDeepMemo = (id) => post(`/startups/${id}/deep-memo`)
